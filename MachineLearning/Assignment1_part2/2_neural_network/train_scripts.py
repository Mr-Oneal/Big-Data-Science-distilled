...
def train(patterns_input, #truth table
          patterns_output, # array with output of truth table 
          n_hidden_neurons, #2
          iterations, #10000
          learning_rate, #1.0
          test_set_input=None,
    ...
    n_samples = patterns_input.shape[0] #4
    # get the number of elements for each sample from the data
    n_inputs = patterns_input.shape[1] #2 , number of colums of truth table without result
    
    # get a sample from the labels
    sample_y = patterns_output[0] #0
